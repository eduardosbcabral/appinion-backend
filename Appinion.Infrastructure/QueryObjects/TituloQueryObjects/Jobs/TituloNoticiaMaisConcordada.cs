...
{
    public class TituloNoticiaMaisConcordada : IJob
    {
        ...
        public TituloNoticiaMaisConcordada(IQueryObject<TituloNoticiaQuery> tituloNoticiaQuery, INoticiaRepository noticiaRepository, ITituloNoticiaRepository tituloNoticiaRepository)
        {
